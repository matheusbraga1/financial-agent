...
class ConversationService:
    def __init__(self, db_path: Optional[str] = None):
        ...
        # Retenção configurável (padrão: 90 dias) e janela mínima entre purgas
    ...
    def _connect(self):
        # Timeout ajuda a evitar "database is locked" sob contenção leve
        conn = sqlite3.connect(self.db_path, check_same_thread=False, timeout=5.0)
        conn.row_factory = sqlite3.Row
        # PRAGMAs de robustez/desempenho para workload de gravação leve
        try:
    ...
    def _init_db(self):
        with self._lock, self._connect() as conn:
            ...
            # Índices para acelerar histórico por sessão e ordenação temporal
    ...
    def _purge_if_needed(self, conn: sqlite3.Connection):
        ...
        try:
            ...
            # Não interrompe o fluxo caso limpeza falhe
            pass
        finally:
