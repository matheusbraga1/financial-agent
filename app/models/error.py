...
class ErrorResponse(BaseModel):
    ...
    trace_id: Optional[str] = Field(None, description="ID de rastreamento da requisição (X-Request-ID)")
    details: Optional[Any] = Field(None, description="Detalhes adicionais do erro (quando aplicável)")
